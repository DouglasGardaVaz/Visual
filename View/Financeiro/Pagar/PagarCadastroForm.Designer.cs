namespace Dados.View.Financeiro.PagarCadastroFormulario
{
    partial class PagarCadastroForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            pnlConteudo.Controls.Add(tbPagar);
            ...
            // tbPagar
            // 
            tbPagar.Controls.Add(tbCadastro);
            tbPagar.Controls.Add(tbAdicional);
            tbPagar.Dock = DockStyle.Fill;
            tbPagar.Location = new Point(0, 0);
            tbPagar.Name = "tbPagar";
            tbPagar.SelectedIndex = 0;
            tbPagar.Size = new Size(482, 509);
            tbPagar.TabIndex = 39;
            // 
            // tbCadastro
            // 
            ...
            lblValorPago.Size = new Size(67, 15);
            ...
            dtPagamento.Location = new Point(260, 102);
            ...
            gbInformacoesGerais.Controls.Add(txtFornecedor);
            ...
            // txtFornecedor
            // 
            txtFornecedor.Location = new Point(233, 99);
            txtFornecedor.MaxLength = 8;
            txtFornecedor.Name = "txtFornecedor";
            txtFornecedor.ReadOnly = true;
            txtFornecedor.Size = new Size(176, 21);
            ...
            MaximizeBox = false;
            MinimizeBox = false;
            Name = "PagarCadastroForm";
            ShowIcon = false;
            ShowInTaskbar = false;
            StartPosition = FormStartPosition.CenterScreen;
            Text = "Cadastro pagar";
            Load += PagarCadastroForm_Load;
            Shown += PagarCadastroForm_Shown;
            KeyDown += PagarCadastroForm_KeyDown;
            pnlRodape.ResumeLayout(false);
            tbLayoutAcoes.ResumeLayout(false);
            pnlConteudo.ResumeLayout(false);
            tbPagar.ResumeLayout(false);
