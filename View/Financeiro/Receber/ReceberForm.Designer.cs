namespace Dados.View.Financeiro.ReceberFormulario
{
    partial class ReceberForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            tableLayoutPanel1.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 16.6221619F));
            tableLayoutPanel1.Controls.Add(lblTotalaReceber, 4, 0);
            tableLayoutPanel1.Controls.Add(lblTotalRecebido, 2, 0);
            ...
            // lblTotalaReceber
            // 
            lblTotalaReceber.AutoSize = true;
            lblTotalaReceber.Dock = DockStyle.Fill;
            lblTotalaReceber.Font = new Font("Arial", 9F, FontStyle.Bold);
            lblTotalaReceber.Location = new Point(752, 0);
            lblTotalaReceber.Name = "lblTotalaReceber";
            lblTotalaReceber.Size = new Size(147, 25);
            lblTotalaReceber.TabIndex = 11;
            lblTotalaReceber.Text = "TotalaReceber";
            lblTotalaReceber.TextAlign = ContentAlignment.MiddleCenter;
            // 
            // lblTotalRecebido
            // 
            lblTotalRecebido.AutoSize = true;
            lblTotalRecebido.Dock = DockStyle.Fill;
            lblTotalRecebido.Font = new Font("Arial", 9F, FontStyle.Bold);
            lblTotalRecebido.Location = new Point(453, 0);
            lblTotalRecebido.Name = "lblTotalRecebido";
            lblTotalRecebido.Size = new Size(144, 25);
            lblTotalRecebido.TabIndex = 9;
            lblTotalRecebido.Text = "TotalRecebido";
            lblTotalRecebido.TextAlign = ContentAlignment.MiddleCenter;
            // 
            // lblTotalVencida
            // 
            ...
            Text = "Gerencial receber - GARSTEN - 2025";
            FormClosing += ReceberForm_FormClosing;
            Load += ReceberForm_Load;
            KeyDown += ReceberForm_KeyDown;
