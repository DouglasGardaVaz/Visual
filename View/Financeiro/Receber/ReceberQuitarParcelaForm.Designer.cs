namespace Dados.View.Financeiro.ReceberQuitarParcelaFormulario
{
    partial class ReceberQuitarParcelaForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            label6 = new Label();
            txtValoraSerRecebido = new TextBox();
            label5 = new Label();
            ...
            gbParcela.Controls.Add(txtValoraSerRecebido);
            ...
            label6.TabIndex = 45;
            label6.Text = "Valor a ser recebido";
            // 
            // txtValoraSerRecebido
            // 
            txtValoraSerRecebido.Enabled = false;
            txtValoraSerRecebido.Location = new Point(201, 46);
            txtValoraSerRecebido.Name = "txtValoraSerRecebido";
            txtValoraSerRecebido.Size = new Size(74, 21);
            txtValoraSerRecebido.TabIndex = 44;
            txtValoraSerRecebido.Tag = "valor2";
            txtValoraSerRecebido.Text = "0,00";
            txtValoraSerRecebido.TextAlign = HorizontalAlignment.Right;
            // 
            // label5
            // 
            ...
            MaximizeBox = false;
            MinimizeBox = false;
            Name = "ReceberQuitarParcelaForm";
            ShowIcon = false;
            ShowInTaskbar = false;
            StartPosition = FormStartPosition.CenterScreen;
            Text = "Quitar parcela";
            Load += ReceberQuitarParcelaForm_Load;
            KeyDown += ReceberQuitarParcelaForm_KeyDown;
        ...
        private TextBox txtValoraSerRecebido;
    }
}